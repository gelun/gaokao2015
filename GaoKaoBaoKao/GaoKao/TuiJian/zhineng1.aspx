<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zhineng1.aspx.cs" Inherits="GaoKao.TuiJian.zhineng1" %>
            ...
            <asp:Repeater ID="rpt_PiCiList" runat="server" OnItemDataBound="rpt_PiCiList_ItemDataBound">
                <ItemTemplate>
                    ...
                    <asp:Panel ID="Panel1" runat="server">
                        <div class="zybpc">
                            <div class="pcTit">
                                <%#Eval("PcName")%><%#Eval("PiCi").Equals(studentChengJi.PiCi) ? "<span>重点填报</span>":""%></div>
                            <div class="zybpcL">
                                <ul>
                    ...
                    <asp:Panel ID="Panel2" runat="server">
                        <div class="zybpc">
                            <div class="pcTit">
                                <%#Eval("PcName")%><%#Eval("PiCi").Equals(studentChengJi.PiCi) ? "<span>重点填报</span>":""%>
