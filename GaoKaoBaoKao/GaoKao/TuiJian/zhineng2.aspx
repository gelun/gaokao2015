<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zhineng2.aspx.cs" Inherits="GaoKao.TuiJian.zhineng2" %>
    ...
    <script type="text/javascript">
        ...
        function getList() {
            $.ajax({
                ...
                type: "post",
                dataType: "html",
                data: { StudentProvinceId:<%=userinfo.ProvinceId %>,StudentId:<%=userinfo.StudentId %>,StudentKeLei:<%=userinfo.KeLei %>,StudentPiCi:<%=provincePiCi.PiCi %>,StudentPcLeiBie:<%=provincePiCi.PcLeiBie %>,schoolname: $("#hidSchoolName").val(),zhuanye:$("#hidZhuanYe").val(), tese: getCheckList(1), cengci: getCheckList(2), xingzhi: getCheckList(3), belong: getCheckList(4), leixing: getCheckList(5), province: getCheckList(6),fengxian:getCheckList(9), p: 1 },
        ...
        <div class="contentbody">
            ...
            <div class="zyblist">
                <ul>
                    ...
                    <li>总分：<span><%=studentChengJi.FenShu %></span></li>
                    <li>累计人数：<span><%=studentChengJi.LeiJiRenShu %></span></li>
                    <li>同分人数：<span><%=studentChengJi.RenShu %></span></li>
                    <li>省份：<span><%=userinfo.ProvinceName %></span></li>
                    <li>预计<%=DAL.Common.GetPiCiName(studentChengJi.PiCi, userinfo.ProvinceId)%>录取</li>
