...
namespace GaoKao.GaoKaoCard
{
    public partial class DingDan : System.Web.UI.Page
    {
        ...
        {
            //卡的类别名称
            lblDanJia.Text = "288.00";

            //  lblDanJia.Text = "0.01";

            if (!IsPostBack)
            {
                string ty = Basic.RequestHelper.GetQueryString("ty");
                string bm = Basic.RequestHelper.GetQueryString("bm");
                if (ty == "djq")
                {
                    if (bm == "ART0319815")
                    {
        ...
        protected void imgSave_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                string strDaiJinQuan = this.txtDaiJinQuan.Text;
                ...
                //总金额
                decimal decTotleJinE = decDanJia * intCount - (strDaiJinQuan == "ART0319815" ? 30 : 0);
                ...
                string strSubject = strCellName + "购买了" + intCount + "张，" + strProvinceName + " 高考报考卡";


                //订单详情
                string strBody = strCellName + "（" + strCellMobile + "）于" + DateTime.Now + "，购买了" + intCount + "张，" + strProvinceName + "的高考报考卡,每张卡的金额为" + lblDanJia.Text + "，此次订单的总金额为" + decTotleJinE + "。" + (strDaiJinQuan == "ART0319815" ? "使用了高考报考30元代金券" : "");
        ...
        void YinLian(Entity.DingDan info)
        {
            if (info != null)
            {
                ...
                param["commodityUrl"] = "http://gaokao.gelunjiaoyu.com/gaokaocard/ReturnUrl.aspx";  // 商品URL
                ...
                param["frontEndUrl"] = "http://gaokao.gelunjiaoyu.com/gaokaocard/YinLian/FontPay.aspx";  // 前台回调URL
                param["backEndUrl"] = "http://gaokao.gelunjiaoyu.com/gaokaocard/YinLian/BackPay.aspx";   // 后台回调URL
