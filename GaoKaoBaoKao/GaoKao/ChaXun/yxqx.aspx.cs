...
{
    public partial class yxqx : Base
    {
        public int gl_Lx = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dtSchool = DAL.BenKeFenShu.BenKeFenShuList(" TOP 20 YuanXiaoMingCheng,Count(*) AS SchoolCount ", strWhere + " GROUP BY YuanXiaoMingCheng ORDER BY SchoolCount DESC;", DataYear.ToString());

            strHighCharts = strHighCharts + Basic.HighCharts.CreatHighChartsPie3DFromDT("dqtjt", "", "院校去向比例", dtSchoolProvince);
            strHighCharts = strHighCharts + Basic.HighCharts.CreatHighChartsPie3DFromDT("yxtjt", "", "院校去向比例", dtSchool);
