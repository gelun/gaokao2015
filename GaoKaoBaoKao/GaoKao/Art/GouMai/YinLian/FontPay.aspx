<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FontPay.aspx.cs" Inherits="GaoKao.Art.GouMai.YinLian.FontPay" %>
        ...
        $(function () {
            ...
            switch (result * 1) {
                ...
                case 2: //卡号无效
                    $("#zhifuchenggong").hide();
                    $("#zhifushibai").show();
                    $("#fukuanjieguo").text("卡号无效");
                    setTimeout(times, 1000);
                    break;
                case 3: //余额不足
                    $("#zhifuchenggong").hide();
                    $("#zhifushibai").show();
                    $("#fukuanjieguo").text("余额不足");
                    setTimeout(times, 1000);
                    break;
                case 4: //订单支付失败,请重新进行支付操作
                    $("#zhifuchenggong").hide();
                    $("#zhifushibai").show();
                    $("#fukuanjieguo").text("订单支付失败");
                    setTimeout(times, 1000);
                    break;
                default: //订单支付失败,请重新进行支付操作
                    $("#zhifuchenggong").hide();
                    $("#zhifushibai").show();
                    $("#fukuanjieguo").text("订单支付失败");
                    setTimeout(times, 1000);
...
<body>
    ...
    <div id="zhifushibai" style="border-bottom: 1px solid #c8c8c8; width: 100%;">
        <div class="chenggong">
            <div id="fksb">
                <div class="cuo">
                    <span id="fukuanjieguo">付款失败</span></div>
                <p>
