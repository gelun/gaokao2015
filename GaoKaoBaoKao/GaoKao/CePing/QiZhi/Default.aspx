<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GaoKao.CePing.QiZhi.Default" %>
...
<body onload=" page_Loading();">
    ...
    <div class="box box_c">
        <div class="bc bc_t">
            <div class="bc_t_l">
                <img src="/images/logo.png" /><span>气质测试</span></div>
            <div class="bc_t_r">
                <div class="bc_t_r_l">
                    答题进度：</div>
                <div class="jdt">
                ...
                <div class="bc_t_r_b">
                    <span id="answer">0</span>/<%=recordNumber%></div>
            </div>
        </div>
        <div class="bc bc_c">
            <div class="bccl">
                    ...
                    <asp:Repeater ID="rpt_List1" runat="server">
                        <ItemTemplate>
                            <li class="q">
                                <div class="ct">
                                    <div class="cti">
                                         <asp:Label ID="testNumber" runat="server" Text='<%#  Eval("TestNumber") %>'></asp:Label></div>
                                    <div class="ctt">
                                        <%# Eval("TestTitle")%></div>
                                </div>

                                <asp:HiddenField ID="hidd" runat="server"  Value='<%# Eval("TestType") %>'/>
                                <asp:RadioButtonList ID="rdb_Check" runat="server" RepeatDirection="Horizontal" CssClass="a">
        ...
        <div class="bc bcb">
            ...
            <asp:ImageButton ID="subbut" runat="server" class="right" ImageUrl="/images/btn_next.png"
                OnClick="subbut_Click" OnClientClick="return nextclick();" />
        </div>
    </div>
    <div class="box">
