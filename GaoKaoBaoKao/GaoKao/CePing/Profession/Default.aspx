<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GaoKao.CePing.Profession.ProfessionTest" %>
...
<body onload=" page_Loading();">
    ...
    <div class="box box_c">
        <div class="bc bc_t">
            <div class="bc_t_l">
                <img src="../images/logo.png" /><span>职业价值观测评</span></div>
            <div class="bc_t_r">
                    ...
                    <asp:Repeater ID="rpt_List1" runat="server" 
                       >
                        <ItemTemplate>
                             <li class="q">
                                    <div class="ct">
						            <div class="cti"><%# Eval("ProfessionNumber")%>.</div>
						            <div class="ctt"><%# Eval("ProfessionTitle")%></div>
						            </div>
                                      <asp:HiddenField ID="hd" runat="server" Value='<%# Eval("GroupNumber") %>' />
