<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GaoKao.CePing._16PF.Default" %>
...
<head>
    ...
    <script type="text/javascript">
             ...
             function  page_Loading(){
                ...
                var  anNumber=(<%=page %>-1)*<%=pageSize %>+loadNumber;
                ...
                var  radioNumber=$(".bc_c input:radio").length;
                    //计算进度条长度
                var  plan=anNumber*$(".jdt").width()/(radioNumber/3);
                $("#plan").css("width",plan);
...
<body onload=" ">
    ...
    <div class="box box_c">
        <div class="bc bc_t">
            <div class="bc_t_l">
                <img src="../images/logo.png" /><span>个人性格测评</span></div>
            <div class="bc_t_r">
                <div class="bc_t_r_l">
                    答题进度：</div>
                <div class="jdt">
                    ...
                    <asp:Repeater ID="rpt_List1" runat="server" OnItemDataBound="rpt_List1_ItemDataBound">
                        <ItemTemplate>
                            <li class="q">
                                ...
                                <asp:RadioButtonList ID="rdb_Check" runat="server" RepeatDirection="Vertical" RepeatLayout="UnorderedList"
                                    CssClass="a">
                                </asp:RadioButtonList>
