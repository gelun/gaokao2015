<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GaoKao.CePing.WenLi.Test" %>
...
<body onload=" page_Loading();">
    ...
    <div class="box box_c">
        ...
        <div class="bc bc_c">
            <div class="bccl">
                <ul>
                    ...
                    <li class="q">
                        <div class="ct">
						<div class="cti"><%# Eval("TestId")%>.</div>
						<div class="ctt"><%# Eval("TestTitle")%></div>
						</div>
                            	         <asp:HiddenField ID="hd1" runat="server" Value='<%# Eval("TestId") %>' />
                                         <asp:RadioButtonList class="a"  ID="rbL" runat="server" RepeatDirection="Vertical" RepeatLayout="UnorderedList">
                                            <asp:ListItem>
                                                 非常喜欢
                                            </asp:ListItem>
                                             <asp:ListItem>
        ...
        <div class="bc bcb">
			<span class="alert_info" id="errorinfo"></span><asp:ImageButton ID="next" 
                ImageUrl="../images/btn_next.png" runat="server" onclick="next_Click"  OnClientClick="return nextclick();" />
        </div>
    </div>
    <div class="box">
