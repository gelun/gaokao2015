<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="GaoKao.CePing.WenLi.About" %>
...
<body>
    ...
    <div id="show" style="display: none;">
        <iframe id="test" src="" width="830px" height="530px;" style="border: 0px solid #000;">
        </iframe>
    </div>
    </form>
</body>
