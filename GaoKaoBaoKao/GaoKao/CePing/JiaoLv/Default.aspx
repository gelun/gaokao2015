<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GaoKao.CePing.JiaoLv.Default" %>
                               ...
                               if(c==0){
                                ...
                                if(c==2){
                                 $(this).next().text("C："+$(this).next().text()) ;
                                  ...
                                  if(c==3){
                                 $(this).next().text("D："+$(this).next().text()) ;
                                }
                           });
                    });
...
<body onload=" page_Loading();">
    ...
    <div class="box box_c">
        <div class="bc bc_t">
            <div class="bc_t_l">
                <img src="../images/logo.png" /><span>考试焦虑测试</span></div>
            <div class="bc_t_r">
                <div class="bc_t_r_l">
                    答题进度：</div>
                <div class="jdt">
