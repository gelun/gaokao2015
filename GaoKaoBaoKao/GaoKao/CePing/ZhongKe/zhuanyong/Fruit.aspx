<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fruit.aspx.cs" Inherits="GaoKao.CePing.ZhongKe.Fruit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>学习力测评</title>
    <link href="/CePing/css/style.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="contants">
        <table width="1000" align="center" cellpadding="4" class="tab6">
            <tr>
                <th width="619" valign="top" colspan="3">
                    <p>
                        学习力测评结果
                    </p>
                </th>
    ...
    <div class="pingshu contants">
        <p>评述</p>
        <div class="pingshuContent">
    ...
    <div class="fx"  style=" display:none;">
        ...
        <ul>
         ...
         <ul>
            ...
            <li>当孩子不喜欢学习的时候，首先要做的是了解孩子不喜欢的原因，不要简单的归结为学习态度的问题，可能是孩子不喜欢他的老师，或者在学校和同学之前有了误会，而我们却一直忽略了，先找到原因，在正确的引导和处理。</li>
             <li>端正学习态度：家长遇到不开心的事跟孩子说，孩子是可以依赖的，把孩子当自己生活中的伴儿，可很好的增强孩子的责任承担能力，而责任承担能力是形成良好学习态度的前提，孩子会把学习当成自己的责任去自觉地承担。千万不要给孩子灌输这种类似的想法：只要你好好学习就行，家里任何事情都不用你来操心。恰恰相反，日常生活中的事情与学习态度和学习能力的形成是相辅相成的。还可以告诉孩子，你的学习和爸爸妈妈的工作是一样的，学习就是你的工作。爸爸妈妈必须要工作因为爸爸妈妈要对自己、你和爷爷奶奶负责，需要赚钱让我们生活快乐。而你必须要学习是因为你要对你自己负责，你需要学习来快点长大，才能做自己喜欢的事情，未来才能生活快乐等等。让孩子明白学习是自己的责任不是为别人而学。</li>
        </ul>
    </div>
     ...
     <div   class="fangfa">
        <ul>
            <li>学习方法的摸索：家长不要强硬地命令要求孩子去怎么写作业、背书，被动学习的效率永远不会高。家长可以在孩子放松的时候，和孩子一起探讨学习的方法，家长把自己以前的学习经历和孩子说说，比如：妈妈以前背书就是一句一句地死背，却还是背不出来，你有什么好办法呢；你这样做题的方法很好，妈妈以前就没有你这么聪明等等。适时地夸奖孩子，让孩子对学习树立信心，主动去思考学习的方法。还可以和孩子一起制定一个只针对放学后的学习计划：回到家先做什么后做什么、如果前一个没有完成就不能做后一个。然后学习计划逐步扩大到一天的、一星期的、一月的，通过这种方式，孩子会逐渐学会安排自己的时间。</li>
     ...
     <div   class="zijian">
        <ul>
         ...
         <ul>
            ...
            <li>学习的自检性：孩子会关注他人的学习，说明他对于学习还是有期待竞争的，家长要做的就是引发孩子的学习自检性。每次考完试、放学后都可以和孩子交流一下今天的学习情况，思考一下该怎么提升自己，要注意语气，不要强硬、强制，要用温和、引导式的语气。</li>
        </ul>
         <ul>
    ...
    <script type="text/javascript">
            ...
            $(".fen").each(function (n) {
                ...
                switch (n) {
                    case 0:
                        ...
                        if (fen <= 30) {
                            lvel = "较低";
                            pingshu += getIndex(n, 0);
                        }
                        else if (fen >= 31 && fen <= 60) {
                            lvel = "中等";
                            pingshu += getIndex(n, 1);


                        }
                        else if (fen >= 61) {
                            lvel = "较高";
                            pingshu += getIndex(n, 2);
                        }
        ...
        function getIndex(din,ulin) {
            ...
            //取出非随机数的字段
            var  st="";
            for(var i=0;i<$(".fx  div:eq(" + din + ") ul:eq(" + ulin + ")  li").length;i++){
                if (i != tCount) {
                    st +="<p>"+ $(".fx  div:eq(" + din + ") ul:eq(" + ulin + ")  li:eq(" + i + ")").text()+"</p>"
                }
            }
