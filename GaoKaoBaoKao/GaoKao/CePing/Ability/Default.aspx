<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GaoKao.CePing.Ability.AbilityTest" %>
...
<body onload=" page_Loading();">
    ...
    <div class="box box_c">
        <div class="bc bc_t">
            <div class="bc_t_l">
                <img src="../images/logo.png" /><span>职业能力测评</span></div>
            <div class="bc_t_r">
        ...
        <div class="bc bc_c">
                       ...
                       >
                        <ItemTemplate>
                             <li class="q">
						            ...
						            <div class="ctt"><%# Eval("AbilityTitle")%></div>
						            </div>
                                      <asp:HiddenField ID="hd" runat="server" Value='<%# Eval("AbilityNumber") %>' />
                                        ...
                                        <asp:HiddenField ID="hdType" runat="server"  Value='<%# Eval("GroupNumber") %>' />
            ...
            <div class="bccr">
                <ul>
                    <asp:Repeater ID="rpt_List2" runat="server" 
                       >
                        <ItemTemplate>
                             <li class="q">
                                    <div class="ct">
						            <div class="cti"><%# (page-1) * pageSize +1+ Container.ItemIndex + rpt_List1.Items.Count%>.</div>
						            <div class="ctt"><%# Eval("AbilityTitle")%></div>
						            </div>
                                      <asp:HiddenField ID="hd" runat="server" Value='<%# Eval("AbilityNumber") %>' />
                                        <asp:RadioButtonList ID="rdb_Check" runat="server" RepeatDirection="Vertical" RepeatLayout="UnorderedList" CssClass="a">
