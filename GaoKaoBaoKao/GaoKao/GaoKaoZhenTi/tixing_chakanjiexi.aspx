<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tixing_chakanjiexi.aspx.cs"
    Inherits="GaoKao.GaoKaoZhenTi.tixing_chakanjiexi" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function jieguo() {
            ...
            location.href = "tixing_jiaojuan.aspx?subjectid=" + subjectid + "&typeid=" + typeid + "&zubie=<%=strZuBie %>";
        }
    </script>
</head>
<body>
    ...
    <div id="Messagewrap1">
        <div id="Messagewrap">
            <div class="now">
                ...
                >> <a href="/gaokaozhenti/index.aspx">题型练习</a> >> 选择题 >> <span>查看解析</span></div>
            <h1>
