<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zsd_xuanze.aspx.cs" Inherits="GaoKao.GaoKaoZhenTi.zsd_xuanze" %>
            ...
            $.ajax({
                ...
                success: function (msg) {
                    if (msg == "success") {
                        ...
                        setTimeout(function () {
                            //跳转页面
                            location.href = "zsd_jiaojuan.aspx?subjectid=" + subjectid + "&zsdid=" + typeid + "&zubie=" + zubie;
                        }, 1000);
                    } else {
...
<body>
    ...
    <div id="Messagewrap1">
        <div id="Messagewrap">
            ...
            <h1>
                知识点练习<span><%=strSubjectName%></span><i>时间 <font id="shijian">00:00:00</font></i>
            </h1>
            <div class="content">
