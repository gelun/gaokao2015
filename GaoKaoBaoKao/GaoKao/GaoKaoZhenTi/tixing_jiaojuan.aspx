<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tixing_jiaojuan.aspx.cs"
    Inherits="GaoKao.GaoKaoZhenTi.tixing_jiaojuan" %>
...
<head>
    ...
    <script type="text/javascript">
        function jiexi() {
            ...
            location.href = "tixing_chakanjiexi.aspx?subjectid=" + subjectid + "&typeid=" + typeid + "&zubie=" + zubie;
        }
    </script>
</head>
<body>
    ...
    <div id="Messagewrap1">
        ...
        <div id="Messagewrap">
            <div class="now">
                ...
                >> <a href="/gaokaozhenti/index.aspx">题型练习</a> >> 选择题 >> <span>查看结果</span></div>
            <h1>
