<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRZL.aspx.cs" Inherits="GaoKao.Persional.GRZL" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if (ProvinceId != "0") {
                ...
                $("input[type='radio'][value='" + kelei + "']").attr("checked", "checked");
                if (kelei == "-1") {
                    //未分科
                    $("input[type='radio'][value='" + kelei + "']").attr("checked", "checked");
                }
            ...
            $(".tjbutton").click(function () {
                ...
                //高考分科
                var kelei = $("input[type='radio']:checked").val();
                if (kelei == undefined) {
                    alert("请选择高考分科");
                    return false;
                }
        ...
        function getSelList(proid) {
            $.ajax({
                url: $("#form1").attr("action"),    // 提交的页面
                data: { ty: "districtlist", proid: proid },       // 从表单中获取数据
                ...
                success: function (data) {
                    if (data != "") {
                        ...
                        optionHTML = "<option value=\"0\">--县/区--</option>\n" + optionHTML;
                        $("#sel3").html(optionHTML);


                        //级联
                        var countyid = $("#hidCountyId").val();
                        if (countyid != "" && countyid != "0") {
                            $("#sel3 option[value='" + countyid + "']").attr("selected", true);
                        }

                    } else {
                        var optionHTML = "<option  value=\"0\">--县/区--</option>";
                        $("#sel3").html(optionHTML);
                    }
                }
            });
            ...
            <div class="xiugaiR">
                ...
                <div class="grxxtab">
                    ...
                    <div class="grxxtabR">
                        ...
                        <asp:DropDownList ID="sel2" runat="server" class="selecttab">
