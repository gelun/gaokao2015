...
namespace Basic
{
    ...
    public class Utils
    {
        ...
        //去除含有非法字符
        public static string GetNewString(string strString)
        {

            return "";
        }

        string GetNewString(string strGuiLvZiFu, string strString)
        {
            if (strString.Contains(strGuiLvZiFu))
            {
                strString.Replace(strGuiLvZiFu, "");
